...
public class sparseMartix 
{
	...
	{
		try {
			Workbook book=Workbook.getWorkbook(new File("D:\\test.xls")); //*************创建读
			Sheet sheet=book.getSheet(0);//0代表第一个工作对象
			...
			String substr=null;
				...
				{
					String ID=sheet.getCell(0,z).getContents();//0代表列数，z代表行数
...
void rankCal(double[] rankMartix,double[][] rankResult)//迭代计算
	...
	public static void main(String[] args) throws BiffException, IOException
	{
		...
		martix.read();//掉用读函数，以便生成新的Excel表
